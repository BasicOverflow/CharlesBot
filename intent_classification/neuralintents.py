...
#NOTE: I've modified the file a bit to fix a bug with saving the model in wrong dir
...
class GenericAssistant(IAssistant):
    ...
    def __init__(self, intents, intent_methods={}, model_name="assistant_model"):
        self.root = json.load(open("./settings.json", "r"))["intent_classifier_dir"]
        self.intents = intents
        self.intent_methods = intent_methods
        self.model_name = f"{self.root}/model/{model_name}"
    ...
    def _predict_class(self, sentence):
        #NOTE: CPU-bound work taking place here. Consider using multiprocessing 
